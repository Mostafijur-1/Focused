...
import { revokeAdminUserSessionsSchema } from "@/features/admin/transport/admin-schemas";
  ...
  return handleApiRoute(
    ...
    async (requestId) => {
      ...
      const [context, body, params] = await Promise.all([
        ...
        parseJson(request, revokeAdminUserSessionsSchema),
        route.params,
      ]);
      return apiSuccess(
        {
          data: await getAdminService().revokeUserSessions(context, {
            ...body,
